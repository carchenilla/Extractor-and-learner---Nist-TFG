...
class Ui_TFG(object):
    def setupUi(self, TFG):
        ...
        self.pushButton = QtGui.QPushButton(TFG)
    ...
    def retranslateUi(self, TFG):
        ...
        self.label_13.setText(_translate("TFG", "% of sets for training", None))
...
" and validate", None))
        ...
        self.svm_kernel_box.setItemText(2, _translate("TFG", "poli", None))
...
" and validate", None))
        ...
        self.label.setText(_translate("TFG", "% of sets for training", None))
